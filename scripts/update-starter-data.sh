...
docker compose exec drupal /bin/bash -c 'drush -y sql-sanitize'
...
docker compose exec drupal /bin/bash -c 'drush sql-dump' > ./drupal/starter-data/initial.sql
...
docker compose exec drupal /bin/bash -c 'cp -r /var/www/html/sites/default/files /starter-data/files'
docker compose exec drupal /bin/bash -c 'cp -r /drupal-private-files /starter-data/private-files'
docker compose exec drupal /bin/bash -c 'rm -rf /starter-data/files/languages /starter-data/files/css /starter-data/files/js /starter-data/files/php /starter-data/files/styles /starter-data/files/.htaccess'
